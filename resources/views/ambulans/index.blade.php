        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border"><!--<h3 class="box-title">Data User</h3>-->
                    <a href="{{route('ambulans.create')}}" class="btn btn-success btn-sm">Tambah Ambulans</a><br>
                    <div class="box-tools">
                ...
                <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                                <tbody>
                                        ...
                                        <a class="btn btn-info btn-sm disabled" href="{{route('ambulans.show',['id'=>$ambulan->id])}}" >Detail</a>
                                        <a class="btn btn-primary btn-sm disabled" href="{{route('ambulans.edit',['id'=>$ambulan->id])}}">Ubah</a>
