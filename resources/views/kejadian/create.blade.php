        ...
        <div class="row">
            <form enctype="multipart/form-data" action="{{route('kejadian.store')}}" method="POST">
                ...
                <div class="col-xs-6">
                    ...
                    <input value="{{ old('pelapor') }}" class="form-control" placeholder="Nama Pelapor" type="text" name="pelapor" id="pelapor" />
                    @error('pelapor')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <textarea name="lokasi" id="lokasi" class="form-control">{{ old('lokasi') }}</textarea>
                    @error('lokasi')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <input value="{{ old('telpon') }}" class="form-control" placeholder="" type="text" name="telpon" id="telpon" />
                    @error('telpon')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <input value="{{ old('nama_korban') }}" class="form-control" placeholder="Nama Korban" type="text" name="nama_korban" id="nama_korban" />
                    @error('nama_korban')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <input value="{{ old('umur') }}" class="form-control" placeholder="umur" type="number" name="umur" id="umur" />
                    @error('umur')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="radio icheck">
                        <input type="radio" name="jamkes" id="UMUM" value="UMUM" checked >
                        <label for="UMUR">UMUM</label>
                        <input type="radio" name="jamkes" id="BPJS" value="BPJS">
                        <label for="BPJS">BPJS</label>
                        <br>
                    </div>

                    <label for="no_jamkes">No. Kartu</label>
                    <input value="{{ old('no_jamkes') }}" class="form-control" placeholder="No. Kartu" type="number" name="no_jamkes" id="no_jamkes" />
                    @error('no_jamkes')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-xs-6">
                    ...
                    <div class="radio icheck">
                        <input type="radio" name="triage" id="M" value="M" checked>
                        <label for="M">M</label>
                        <input type="radio" name="triage" id="K" value="K">
                        <label for="K">K</label>
                    ...
                    <input value="{{ old('diagnosa') }}" class="form-control" placeholder="Diagnosa Medis" type="text" name="diagnosa" id="diagnosa" />
                    <br>

                    <label for="kejadian_keluhan">Kejadian / Keluhan Masyarakat</label>
                    <textarea name="kejadian_keluhan" id="kejadian_keluhan" class="form-control">{{ old('kejadian_keluhan') }}</textarea>
                    <br>
